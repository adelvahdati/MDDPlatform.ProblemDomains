...
namespace MDDPlatform.ProblemDomains.Infrastructure.SqlDB;
public class ProblemDomainSqlRepository : IProblemDomainRepository
{
    private readonly DbSet<ProblemDomain> _ProblemDomains;
    private readonly AppDbContext _appDbContext;


    public ProblemDomainSqlRepository(AppDbContext appDbContext)
    {
    ...
    {
        _ProblemDomains.Remove(problemDomain);
        await _appDbContext.SaveChangesAsync();
    }
